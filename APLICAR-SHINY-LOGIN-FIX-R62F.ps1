...
Write-Host " SHINY LOGIN R62F - FIX ADMIN + UTF8" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$BackupRoot=Join-Path $ProjectRoot "_gmx_backups\LOGIN-R62F-$stamp"
...
"@,
  ...
  Write-Host ""
  Write-Host "=== GIT DIFF CHECK R62F ===" -ForegroundColor Cyan
  ...
  if($newErrors.Count -gt 0){
    ...
    throw "R62F introdujo errores nuevos de git diff --check."
  }
  ...
  Write-Host " R62F INSTALADO CORRECTAMENTE" -ForegroundColor Green
  ...
  Write-Host "Rollback R62F completado." -ForegroundColor Yellow
  throw
}
