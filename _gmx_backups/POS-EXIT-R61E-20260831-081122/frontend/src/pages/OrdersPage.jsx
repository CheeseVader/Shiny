    ...
    <div className={`pos-stack r23-view r23-orders ${isOperator ? 'operator-pos-page' : ''}`}>
      ...
      >
        ...
        >
          ...
          <h2>Â¿Salir del punto de venta?</h2>
          <p>El punto de venta está bloqueado. Usa Continuar en POS para continuar, o autoriza la salida con la contraseña del operador.</p>
          ...
          <div className="tcg_store_template-pos-exit-actions">
            ...
            <button type="submit" className="danger" disabled={posExitBusy || !posExitPassword}>{posExitBusy ? 'Validando…' : 'Salir de sesiÃ³n'}</button>
          </div>
