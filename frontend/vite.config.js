...
export default defineConfig(({ mode }) => {
  ...
  const appName = env.VITE_APP_NAME || brandConfig.name || 'GMX';
  const shortName = env.VITE_APP_SHORT_NAME || brandConfig.shortName || appName;
  const description = env.VITE_APP_DESCRIPTION || brandConfig.description || 'Plataforma de administración TCG';
