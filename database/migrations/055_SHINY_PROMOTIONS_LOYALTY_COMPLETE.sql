...
CREATE INDEX IF NOT EXISTS ix_promociones_branch_active
  ON shiny.promociones(id_sucursal,estado,inicio,fin);

CREATE INDEX IF NOT EXISTS ix_promociones_redenciones_client
  ON shiny.promociones_redenciones(id_promocion,id_cliente,estado,fecha)
  WHERE id_cliente IS NOT NULL;

INSERT INTO shiny.schema_migrations(version,description)
SELECT '055','Shiny 10.6.2.4.1.12.1.6 - promotions and loyalty complete master module'
WHERE NOT EXISTS(SELECT 1 FROM shiny.schema_migrations WHERE version='055');
