-- GMX_RESET_SCHEMA_V2_2.sql
-- REINICIALIZACIÓN COMPLETA DEL ESQUEMA GMX - V2.2 AUDITADA
-- USAR SOLO PORQUE LOS DATOS ACTUALES SON DE PRUEBA.
--
-- Este script:
--   1) elimina gmx completo;
...
DROP SCHEMA IF EXISTS gmx CASCADE;
CREATE SCHEMA gmx AUTHORIZATION gmx_user;
...
-- Fuente: GMX_Idempotencia
CREATE TABLE gmx_idempotencia (
    row_id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    operation_id TEXT,
    funcion TEXT,
    estado TEXT,
...
VALUES ('002.2', 'GMX reset schema V2.2 - audited semantic types and migration-safe baseline');
