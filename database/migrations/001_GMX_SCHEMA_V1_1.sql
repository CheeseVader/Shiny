...
CREATE TABLE IF NOT EXISTS gmx_idempotencia (
  operation_id TEXT,
  funcion TEXT,
  estado TEXT,
  fecha_creacion TIMESTAMPTZ,
  ...
  error TEXT,
  intentos BIGINT,
  CONSTRAINT pk_gmx_idempotencia PRIMARY KEY (operation_id)
);
...
VALUES ('001','GMX schema base V1.1 - 53 hojas, índices validados y control de migraciones')
