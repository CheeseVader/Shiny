...
SELECT '021','GMX Fase Local 10.5.5 - slideshow media and configurable loyalty'
WHERE NOT EXISTS(SELECT 1 FROM gmx.schema_migrations WHERE version='021');
