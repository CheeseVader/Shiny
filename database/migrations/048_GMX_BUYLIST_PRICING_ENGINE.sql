...
CREATE INDEX IF NOT EXISTS ix_buylist_detalle_price_source
  ON gmx.tcg_buylist_detalle(fuente_base_buylist);

INSERT INTO gmx.schema_migrations(version,description)
SELECT '048','GMX 10.6.2.4.1.10 - Buylist market/store/base pricing engine'
WHERE NOT EXISTS(SELECT 1 FROM gmx.schema_migrations WHERE version='048');
