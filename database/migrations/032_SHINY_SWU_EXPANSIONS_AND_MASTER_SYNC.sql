...
INSERT INTO shiny.tcg_master_sets(
...
SELECT '032','Shiny 10.6.2.2 - SWU official expansions and master catalog synchronization UI'
WHERE NOT EXISTS(
  SELECT 1 FROM shiny.schema_migrations WHERE version='032'
);
