...
VALUES
 ...
 ('public.appearance.brand_name','Shiny'),
...
INSERT INTO shiny.configuracion(parametro,valor)
VALUES
 ('admin.appearance.template','SHINY_ADMIN'),
 ('admin.appearance.brand_name','Shiny'),
 ('admin.appearance.logo_text','G')
ON CONFLICT(parametro) DO NOTHING;

INSERT INTO shiny.schema_migrations(version,description)
SELECT '018','Shiny Fase Local 10.5.2 - dual theme and TCG storefront templates'
WHERE NOT EXISTS(SELECT 1 FROM shiny.schema_migrations WHERE version='018');
