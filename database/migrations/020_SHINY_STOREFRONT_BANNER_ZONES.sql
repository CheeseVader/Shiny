...
SELECT '020','Shiny Fase Local 10.5.4 - storefront banner zones and live preview'
WHERE NOT EXISTS(SELECT 1 FROM shiny.schema_migrations WHERE version='020');
