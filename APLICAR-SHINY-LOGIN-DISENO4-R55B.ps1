...
Write-Host " SHINY LOGIN DESIGN 4 - R55B" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
...
$BackupRoot = Join-Path $ProjectRoot "_gmx_backups\LOGIN-DISENO4-R55B-SHINY-$stamp"
...
'@
  ...
  Write-Host " R55B-SHINY INSTALADO CORRECTAMENTE" -ForegroundColor Green
  ...
  Write-Host "Rollback R55B-SHINY completado." -ForegroundColor Yellow
  throw
}
