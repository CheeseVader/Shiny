-- GMX PRODUCTOS AUD-006/007
-- Trazabilidad de stock inicial multisucursal
--
-- Ejecutar con postgres/owner del esquema antes de reiniciar GMX.
...
ALTER TABLE gmx.movimientos_inventario
...
CREATE INDEX IF NOT EXISTS idx_movimientos_inventario_id_sucursal
  ON gmx.movimientos_inventario (id_sucursal);

CREATE INDEX IF NOT EXISTS idx_movimientos_inventario_id_producto
  ON gmx.movimientos_inventario (id_producto);
