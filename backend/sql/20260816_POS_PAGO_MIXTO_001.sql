...
CREATE TABLE IF NOT EXISTS shiny.pedido_pagos(
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_pedido_pagos_id_pago
  ON shiny.pedido_pagos(id_pago);

CREATE UNIQUE INDEX IF NOT EXISTS uq_pedido_pagos_linea
  ON shiny.pedido_pagos(id_pedido,linea);

CREATE INDEX IF NOT EXISTS ix_pedido_pagos_pedido
  ON shiny.pedido_pagos(id_pedido,fecha DESC);

ALTER TABLE shiny.pedido_pagos
...
WHERE table_schema='shiny' AND table_name='pedido_pagos';
