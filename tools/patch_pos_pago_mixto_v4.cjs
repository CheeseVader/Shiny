...
const backup = `${file}.POS_PAGO_MIXTO_001_V4_${stamp}.bak`;
...
const failedCandidate = path.join(
  path.dirname(file),
  `OrdersPage.POS_PAGO_MIXTO_001_V4_CANDIDATE_${stamp}.jsx`
);
...
console.log('POS-PAGO-MIXTO-001 V4 aplicado y compilado correctamente.');
