GMX POS KIOSK SETUP + ADMIN UX R6
Fecha: 2026-08-21
...
1) PARCHE R6
   ...
   - ESC se usa dentro de GMX para abrir "Salida protegida".
   - El modal aparece sobre el POS.
   - Long-press del logo GMX POS continúa funcionando para tablet/táctil.
   - La contraseña continúa validándose en backend con el mecanismo de R4/R5.

2) TOOLS/GMX_POS_KIOSK
   - Start-GMX-POS-Kiosk.ps1
   - INICIAR_GMX_POS_KIOSK.cmd
   - Install-GMX-POS-Kiosk-Shortcut.ps1
   - Verify-GMX-POS-Kiosk.ps1
...
Ejecutar:
C:\Users\igarcia\Videos\GMX\tools\GMX_POS_KIOSK\INICIAR_GMX_POS_KIOSK.cmd
...
ACCESO DIRECTO
Desde PowerShell:
powershell -ExecutionPolicy Bypass -File .\tools\GMX_POS_KIOSK\Install-GMX-POS-Kiosk-Shortcut.ps1

Esto crea "GMX POS Kiosk" en el Escritorio.
...
- Contraseña correcta: GMX cierra la sesión y muestra Login dentro del kiosco.
...
Ctrl+Alt+Del; GMX no puede ni debe interceptar la pantalla segura de Windows.

RECOMENDACIÓN PRODUCCIÓN
- Usuario Windows dedicado: GMX_POS
- Sin privilegios de administrador
- Windows Assigned Access -> Microsoft Edge
- URL GMX: http://127.0.0.1:5173/admin/pedidos?kiosk=1
- Cuenta GMX OPERADOR con una única sucursal.
...
- Dentro de GMX: long-press 5 segundos sobre GMX POS -> contraseña del operador.
...
modo kiosco/MDM del dispositivo, no al frontend de GMX.
